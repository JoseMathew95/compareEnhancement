package org.autodatacorp.fcaus.steps;
    ...
    private String theRestApiBaseUrl = "https://test2.chrysler.com/hostd/api";
    ...
    public void theResponseShouldContainACompleteListOfOptions() {
        List<Option> generatedOptions = ConfigCompareUtils.GenerateOptionsListForCcodeLlp(list.get(0).get("code"),list.get(0).get("llpCode"),"standard");
    ...
    public void theValuesForFlagsMatchesTheValuesReturnedByConfigureService() {
        List<Option> configOptions = ConfigCompareUtils.retrieveOptionsFromConfigureResponse(list.get(0).get("code"),list.get(0).get("llpCode"),"standard");
        List<Option> compareOptions = ConfigCompareUtils.GenerateOptionsListFromCompareResponse(compareResp);
    ...
    public void theEquipmentCategoriesNodeHasTheCorrectViewsDataForTheModel() {
        JSONObject EquipCatResp =  ConfigCompareUtils.retrieveEquipCatResponse(list.get(0).get("code"),list.get(0).get("llpCode"));
